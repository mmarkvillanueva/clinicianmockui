		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Clinician",
									"targetURL": "#clinicianmockui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"clinicianmockui-display": {
								"semanticObject": "clinicianmockui",
								"action": "display",
								"description": "Clinician Desktop App",
								"title": "Clinician",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=clinicianmockui",
									"url": sap.ui.require.toUrl("clinicianmockui")
								}
							}
						}
					}
